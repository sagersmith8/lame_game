...
//        Paths.get(Thread.currentThread().getContextClassLoader().getResource(textureFile).toURI()).toFile().getAbsolutePath();
        Texture texture = new Texture(Paths.get(Thread.currentThread().getContextClassLoader().getResource(textureFile).toURI()).toFile().getAbsolutePath());
